...
public partial class WindowAnimatedTiles : Window, IFacadeWindow<TileAnimateData>
{
    ...
    TileAnimateData objectData;    

    private double _lastClickTime = 0;
    private const double DoubleClickThreshold = 0.3;
    private Vector2I _originalSize = Vector2I.Zero;
    private Vector2I _originalPosition = Vector2I.Zero;
    private bool _isMaximized = false;

    public event IFacadeWindow<TileAnimateData>.EventNotifyChanguedSimple OnNotifyChanguedSimple;
    public void SetData(TileAnimateData data)
    {
    ...
    {
        objectData.name = objectData.id.ToString();
    ...
    {
        InitializeUI();
        objectData = new TileAnimateData();
