...
//            vel.currentVel = Simulator.Instance.getAgentVelocity(id.Id);
//            extraMov.DesiredPosition = Simulator.Instance.getAgentPosition(id.Id);

//            bool isMoving = vel.currentVel.Length() >= BlockedThreshold;
