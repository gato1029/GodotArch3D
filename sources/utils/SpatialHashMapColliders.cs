...
public class SpatialHashMapColliders<T>
{
    ...
    public int AddColliderObject(T owner, GeometricShape2D shape, Vector2 colliderPosition, GeometricShape2D shapeMove = null)
    {   
        return AddColliderObject(owner, new List<GeometricShape2D> { shape }, colliderPosition,shapeMove);
    }
    public int AddColliderObject(T owner, List<GeometricShape2D> shapes, Vector2 colliderPosition, GeometricShape2D shapeMove =null)
    {
        int colliderId;
        ColliderData<T> data;
    ...
    public List<(T Owner, GeometricShape2D Shape, Vector2 Position)> QueryAABBBInCirclePoints(Vector2 position, float radius, int excludeColliderId = 0, int numberNeighbord = 0)
    {
        ...
        return QueryAABBBrutePoints(area, excludeColliderId,numberNeighbord);
    }
    public List<(T Owner, GeometricShape2D Shape, Vector2 Position)> QueryCirclePoints(Vector2 position, float radius, int excludeColliderId = 0, int numberNeighbord=0)
    {
        var area = new Rect2(position - new Vector2(radius, radius), new Vector2(radius * 2f, radius * 2f));

        var results = QueryAABBBrutePoints(area, excludeColliderId,numberNeighbord);
    ...
    public List<(T Owner, GeometricShape2D Shape, Vector2 Position)> QueryAABBBrutePoints(Rect2 area, int excludeColliderId = 0, int numberNeighbord = 0)
    {
