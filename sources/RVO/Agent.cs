    ...
    internal class Agent
    {
        ...
        internal void computeNewVelocity()
        {
            ...
            for (int i = 0; i < obstacleNeighbors_.Count; ++i)
            {
                ...
                float s = (-relativePosition1.Dot(obstacleVector)) / RVOMath.absSq(obstacleVector);
                ...
                float t = obstacle1 == obstacle2 ? 0.5f : ((velocity_ - leftCutOff).Dot(cutOffVector)) / RVOMath.absSq(cutOffVector);
