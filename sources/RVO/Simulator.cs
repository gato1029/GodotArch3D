    ...
    public class Simulator
    {
        ...
        private class Worker
        {
            ...
            internal void step(object obj)
            {
                ...
                {
                    if (!Simulator.Instance.agents_[agentNo].sleep)
                    {
         ...
         * agent.</param>
         */
        public int addAgent(Godot.Vector2 position)
        {
        ...
        public void doStepAgent(int idAgent)
        {
            agents_[idAgent].computeNeighbors();
            agents_[idAgent].computeNewVelocity();
            agents_[idAgent].update();
        }
        ...
        public float doStep()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < doneEvents_.Length; i++)
                {
                    doneEvents_[i].WaitOne(); // espera 1 segundo
        ...
        public void setAgentSleep(int agentNo,bool sleep)
        {
            agents_[agentNo].sleep = sleep;
        }
